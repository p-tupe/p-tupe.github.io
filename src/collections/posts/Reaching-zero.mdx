...
import reachingZero from "../../audio/reaching-zero.mp3"
import AudioPlayer from "../../pages/components/AudioPlayer.astro"

<br />
<AudioPlayer label="Listen instead: " src={reachingZero} />
<br />
...
2. Start counting backwards with each breath

That is all. Well, sort of.

For the first time I did this, I started off from 100. I easily reached 0. I was not satisfied at all. Next day I went for - wait for it... *500*; thinking it was near impossible to coherently count 500 numbers backwards without missing a single one in my sleepy state. However, I underestimated my excitement and eventually reached zero. (I may have missed some, but reaching zero dwarfed me not counting a few digits)

Was it easy? No. Was it worth it? Hell Yes! The pride you feel after completing a difficult task that even you doubt ever accomplishing yourself is without compare.
