...
> As a side note, I'm using the [neovim](https://neovim.io/) editor on [kitty](https://sw.kovidgoyal.net/kitty/) terminal (it shouldn't matter, but just fyi!)
...
Go ahead and create a new remote repository somewhere like Github, then link it to your local directory. You'll find the remoete url of your repo immediately after you create it - don't forget to update it (using mine will give you errors and bad vibes).
